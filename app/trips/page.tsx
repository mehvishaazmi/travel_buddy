...
const getImage = (destination: string) =>
  `https://picsum.photos/seed/${destination.replace(/\s/g, "")}/1200/700`;
...
export default function TripsPage() {
  ...
  try {
    ...
    (membersData || []).forEach(
      (member) => {
        countMap[member.trip_id] =
          (countMap[member.trip_id] || 0) + 1;
      },
    );
    ...
    const enrichedTrips: TripWithMembers[] =
  ...
  const totalMembers = trips.reduce(
    (sum, trip) => sum + trip.membersCount,
        ...
        <div className="mb-10 flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p
              ...
              "
            >
              Manage your adventures, group expenses, and travel members.
            </p>
          </div>
