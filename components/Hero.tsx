...
import { ArrowRight, MapPin, Search, Sparkles, Calendar, Users, Star, PlayCircle } from "lucide-react";
...
export const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center pt-28 pb-20 overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 h-80 w-80 rounded-full bg-accent/20 blur-3xl animate-float" style={{ animationDelay: "2s" }} />
      <div className="absolute top-1/3 left-1/2 h-64 w-64 rounded-full bg-primary-glow/20 blur-3xl animate-float" style={{ animationDelay: "4s" }} />
      ...
      <div className="container relative">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 max-w-3xl">
            <div className="inline-flex items-center gap-2 rounded-full glass px-4 py-2 text-sm font-medium shadow-soft animate-fade-in">
              ...
              <span className="text-foreground/80">AI-powered trip planning · now in beta</span>
            ...
            <p className="mt-7 text-lg sm:text-xl text-foreground/65 max-w-xl leading-relaxed text-pretty animate-fade-in-up" style={{ animationDelay: "0.1s" }}>
              Discover unforgettable destinations, match with like-minded travelers, build AI-powered itineraries, and split every expense — all in one place.
            </p>

            <div className="mt-9 flex flex-col sm:flex-row gap-3 animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
            ...
            {/* Trust row */}
            <div className="mt-10 flex flex-wrap items-center gap-x-8 gap-y-4 animate-fade-in-up" style={{ animationDelay: "0.3s" }}>
          ...
          <div className="lg:col-span-5 relative hidden lg:block animate-scale-in" style={{ animationDelay: "0.3s" }}>
            <div className="relative h-[520px]">
              ...
              <div className="absolute bottom-12 -left-4 w-[280px] glass rounded-2xl p-4 shadow-elevated animate-float" style={{ animationDelay: "1s" }}>
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="text-sm font-semibold truncate">Sara matched with you</div>
                    <div className="text-xs text-muted-foreground">96% compatibility · Bali</div>
                  </div>
                </div>
              </div>

              {/* Stats floating card */}
              <div className="absolute bottom-0 right-8 w-[220px] glass rounded-2xl p-4 shadow-elevated animate-float" style={{ animationDelay: "2.5s" }}>
                <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                  <Sparkles className="h-3.5 w-3.5 text-primary" />
                  Trip generated
                </div>
                <div className="mt-1 font-display text-2xl font-bold">4 days · Bali</div>
        ...
        {/* Mobile search card */}
        <div className="lg:hidden mt-10 glass rounded-3xl p-3 shadow-elevated max-w-2xl animate-scale-in" style={{ animationDelay: "0.3s" }}>
        ...
        {/* Stats strip */}
        <div className="mt-16 sm:mt-20 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-3xl animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          {[
            { k: "120K+", v: "Travelers" },
            { k: "85+", v: "Countries" },
            { k: "4.9★", v: "App rating" },
            ...
            <div key={s.v} className="border-l-2 border-primary/30 pl-4">
              <div className="font-display text-3xl sm:text-4xl font-bold tracking-tight text-gradient">{s.k}</div>
              <div className="text-xs sm:text-sm text-muted-foreground mt-1 font-medium">{s.v}</div>
            </div>
          ))}
        </div>
      </div>
