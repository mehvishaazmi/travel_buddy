  ...
  "relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.97]",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground shadow-glow hover:shadow-elevated hover:-translate-y-0.5 hover:scale-[1.02]",
        warm: "gradient-warm text-accent-foreground shadow-warm hover:-translate-y-0.5 hover:scale-[1.02]",
        glass: "glass text-foreground hover:bg-white/70 hover:-translate-y-0.5",
      },
      size: {
        default: "h-10 px-4 py-2",
        sm: "h-9 rounded-md px-3",
        lg: "h-12 rounded-xl px-7 text-base",
        xl: "h-14 rounded-2xl px-9 text-base font-semibold tracking-tight",
        icon: "h-10 w-10",
      },
    },
    defaultVariants: {
